/**
 * Generates a professional HTML email template for OTP verification matching the ZawajBD theme.
 */
export const getOtpEmailTemplate = (fullName: string, otp: string, type: 'register' | 'resend'): string => {
